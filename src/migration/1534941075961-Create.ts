...
export class Create1534941075961 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      'CREATE TABLE `users` (`id` varchar(255) NOT NULL, `name` varchar(100) NOT NULL, `email` varchar(255) NOT NULL, `username` varchar(30) NULL, `mobile` varchar(20) NULL, `password` text NOT NULL, `confirmed` tinyint NOT NULL DEFAULT 0, `isBanned` tinyint NOT NULL DEFAULT 0, `lastResetRequestTime` datetime NULL, `profilePic` varchar(255) NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `version` int NOT NULL, `cartId` varchar(255) NULL, INDEX `IDX_836026b660a661f0dbdc467bf1` (`isBanned`), UNIQUE INDEX `IDX_97672ac88f789774dd47f7c8be` (`email`), PRIMARY KEY (`id`)) ENGINE=InnoDB',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE TABLE `books` (`id` varchar(255) NOT NULL, `title` varchar(255) NOT NULL, `slug` varchar(255) NOT NULL, `coverImage` varchar(255) NULL, `description` text NULL, `isbn` varchar(13) NOT NULL, `rating` double NOT NULL DEFAULT 0, `listPrice` double NOT NULL DEFAULT 0, `displayPrice` double NOT NULL DEFAULT 0, `yourSavings` double NOT NULL DEFAULT 0, `datePublished` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `isBanned` tinyint NOT NULL DEFAULT 0, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `version` int NOT NULL, `categoryId` varchar(255) NULL, `cartId` varchar(255) NULL, INDEX `IDX_a79657c9c3666e57c454351645` (`isBanned`), UNIQUE INDEX `IDX_e03f6d84c16e96f5f095ecd331` (`slug`, `isbn`), PRIMARY KEY (`id`)) ENGINE=InnoDB',
    );
    await queryRunner.query(
      'ALTER TABLE `users` ADD CONSTRAINT `FK_89502c44bd22c06e714c31c1e93` FOREIGN KEY (`cartId`) REFERENCES `cart`(`id`)',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `books` ADD CONSTRAINT `FK_b5f614c36da2a4788471e99ca31` FOREIGN KEY (`cartId`) REFERENCES `cart`(`id`)',
    );
  }

  public async down(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      'ALTER TABLE `books` DROP FOREIGN KEY `FK_b5f614c36da2a4788471e99ca31`',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `users` DROP FOREIGN KEY `FK_89502c44bd22c06e714c31c1e93`',
    );
    await queryRunner.query(
